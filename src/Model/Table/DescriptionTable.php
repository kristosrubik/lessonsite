 ...
 * @method \App\Model\Entity\Description newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Description[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Description|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Description|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Description patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Description[] patchEntities($entities, array $data, array $options = [])
...
class DescriptionTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('methods')
            ->requirePresence('methods', 'create')
            ->notEmpty('methods');
